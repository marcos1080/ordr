//
//  VendorItemEditViewController.swift
//  Ordr
//
...
protocol VendorSplitViewMasterDelegate {
    func popToRootView()
}

class VendorItemEditViewController: UIViewController, ViewControllerDelegate, UITextViewDelegate, EditVendorItemDelegate {
    
    let dataManager: DataManager = Model.sharedInstance.dataManager
    
    var slitViewMasterDelegate: VendorSplitViewMasterDelegate?
    ...
    // Set the vendor variable. Used to edit a vendor.
    func editItem( _ vendor: Vendor ) {
        print("edit")
